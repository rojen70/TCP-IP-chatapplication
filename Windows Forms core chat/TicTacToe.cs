    ...
    public class TicTacToe
    {
        ...
        public void StringToGrid(string s)
        {
            ...
            foreach (string symbol in tokens)
            {
                if (symbol == "_")
                {
                    grid[index] = TileType.blank;
                    buttons[index].Text= TileTypeToString(TileType.blank);
                    index++;
                }else if ( symbol == "x")
                {
                    grid[index] = TileType.cross;
                    buttons[index].Text = TileTypeToString(TileType.cross);
                    index++;
                }
                else
                {
                    grid[index] = TileType.naught;
                    buttons[index].Text = TileTypeToString(TileType.naught);
                    index++;
                }
            }
        }
